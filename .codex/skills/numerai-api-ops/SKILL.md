...
```bash
uv run python /path/to/.codex/skills/audit-skill/scripts/inspect_skill_package.py \
  /path/to/numereng/.agents/skills/numerai-api-ops

uv run python /path/to/.codex/skills/audit-skill/scripts/validate_skill_frontmatter.py \
  --check-quoted-fields description \
  --check-metadata-placement \
  /path/to/numereng/.agents/skills/numerai-api-ops

uv run python /path/to/.codex/skills/audit-skill/scripts/validate_skill_routing.py \
  /path/to/numereng/.agents/skills/numerai-api-ops
```
