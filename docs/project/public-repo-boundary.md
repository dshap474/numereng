...
| --- | --- | --- | --- |
| `docs/numerai/` | Keep in repo, exclude from build artifacts | Repo-local docs reader depends on a synced upstream mirror | Governed by `docs/numerai/SYNC_POLICY.md`; `docs/numerai/forum/` remains local-only generated output |
