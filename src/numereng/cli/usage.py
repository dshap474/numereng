...
USAGE = (
    ...
    "  numereng research closeout --experiment-id <id> [--allow-incomplete] [--format <table|json>] [--workspace <path>]\n"  # noqa: E501
    ...
    "  numereng submissions calibration materialize [--dry-run] [--format <table|json>] [--workspace <path>]\n"
