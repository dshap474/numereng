...
def _summarize_prediction_file_with_scores_materialized(
    ...
    *,
    ...
    if int(preflight_meta_stats["meta_model_overlap_rows"]) > 0:
        ...
        meta_stats = {
            "predictions_rows": int(len(predictions)),
            "meta_source_rows": int(preflight_meta_stats["meta_model_source_rows"]),
            "meta_overlap_rows": 0,
            "meta_overlap_eras": 0,
    ...
    provenance: dict[str, object] = {
        ...
        "policy": {
            ...
            "meta_min_overlap_ratio": resolved_scoring_policy.meta_min_overlap_ratio,
...
def _summarize_prediction_file_with_scores_era_stream(
    ...
    *,
    ...
    if feature_neutral_metrics_enabled and not fnc_chunks:
        raise TrainingDataError("training_fnc_no_overlapping_ids")
