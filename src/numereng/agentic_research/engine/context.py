...
from numereng.agentic_research.engine.boundary import ALLOWED_CHANGE_PATHS
...
def run_benchmark_corr_from_disk(*, root: Path, run_id: str) -> float | None:
    """Read the BMC200-window avg corr with the benchmark from a run's metrics.json.
